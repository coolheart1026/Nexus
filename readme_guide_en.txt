...
1. Paste the number into the input field named "ID".

2. Choose to package as a ZIP file or a folder (FOLDER) file.

3. Choose the save location.

4. Click "Start Download" and wait for the download to complete; a real-time loading bar will appear.

Clipboard Detection Mode:

1. Choose to package as a ZIP file or a folder (FOLDER) file.
...
I'm just a novice programmer; please forgive any bugs.
